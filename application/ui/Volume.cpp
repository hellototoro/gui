...
static void CreateVolumePanel(lv_obj_t* parent)
{
    ...
    lv_obj_set_size(VolumePanel, 60, 380);
    lv_obj_set_pos(VolumePanel, 580, 0);
    ...
    lv_obj_set_size(VolumeSlider, 14, 264);
    lv_obj_set_pos(VolumeSlider, 0, -30);
    ...
    lv_obj_set_size(VolumeImage, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
    lv_obj_set_pos(VolumeImage, 0, 145);
