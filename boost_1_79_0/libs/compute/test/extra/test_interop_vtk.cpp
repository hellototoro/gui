...
BOOST_AUTO_TEST_CASE(sort_float_array)
{
    ...
    BOOST_CHECK_EQUAL(array->GetUserValue(0), 1.0f);
    BOOST_CHECK_EQUAL(array->GetUserValue(1), 2.5f);
    BOOST_CHECK_EQUAL(array->GetUserValue(2), 4.0f);
    BOOST_CHECK_EQUAL(array->GetUserValue(3), 6.5f);
}
